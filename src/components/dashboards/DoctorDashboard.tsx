        ...
        <div className="relative z-10 max-w-2xl">
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-blue-600/10 text-blue-600 dark:text-blue-400 rounded-full text-[8px] lg:text-[10px] font-bold uppercase tracking-widest mb-6 border border-blue-500/20 backdrop-blur-sm">
              ...
              On Duty • {profile?.department_id?.name || 'General Medicine'}
            </div>
            ...
            <div className="flex flex-col gap-2 mb-8 lg:mb-10">
              <p className="text-gray-600 dark:text-gray-400 text-base lg:text-lg font-medium leading-relaxed">
                You have <span className="text-gray-900 dark:text-white font-bold">{dashboardData?.stats?.totalAppointments || 0} appointments</span> scheduled for today. 
                Your first patient is arriving in <span className="text-blue-600 dark:text-blue-400 font-bold underline underline-offset-4">15 minutes</span>.
              </p>
              {profile && (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        >
          <div className="p-6 lg:p-10 border-b border-gray-200 dark:border-white/5 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              ...
              <p className="text-sm text-gray-500 font-medium">Manage patients waiting in your department.</p>
            </div>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-gray-200 dark:border-white/5 bg-gray-100/50 dark:bg-white/2">
                  <th className="p-6 text-[10px] font-bold text-gray-500 uppercase tracking-widest">Token</th>
                  <th className="p-6 text-[10px] font-bold text-gray-500 uppercase tracking-widest">Patient</th>
                  <th className="p-6 text-[10px] font-bold text-gray-500 uppercase tracking-widest">Department</th>
                  <th className="p-6 text-[10px] font-bold text-gray-500 uppercase tracking-widest">Priority</th>
                  <th className="p-6 text-[10px] font-bold text-gray-500 uppercase tracking-widest">Wait Time</th>
        ...
        >
          ...
          <div className="relative z-10 flex flex-col md:flex-row gap-8 items-start md:items-center">
            ...
            <div className="flex-1">
              <h3 className="text-2xl font-display font-bold text-gray-900 dark:text-white mb-2">Clinical Decision Support System (CDSS)</h3>
              <p className="text-blue-600/70 dark:text-blue-200/70 text-sm max-w-2xl leading-relaxed">
                Insights based on evidence-based guidelines and patient history to assist in accurate diagnosis and treatment planning.
              </p>
              {cdssInsights && (
            ...
            <div className="flex flex-col gap-4">
              ...
              >
                <option value="" disabled className="bg-white dark:bg-[#0a0a0a]">Select Patient to Analyze</option>
            ...
            {cdssInsights ? (
              ...
              <>
                <div className="bg-white dark:bg-black/20 p-6 rounded-2xl border border-gray-200 dark:border-white/5 opacity-50 shadow-sm dark:shadow-none">
                  <p className="text-[10px] font-bold text-blue-600 dark:text-blue-400 uppercase tracking-widest mb-2">Diagnosis Suggestion</p>
                  <p className="text-sm font-medium text-gray-900 dark:text-white mb-2">Select a patient</p>
                  <p className="text-xs text-gray-500 dark:text-gray-400">Analysis will appear here after running the system.</p>
                </div>
                <div className="bg-white dark:bg-black/20 p-6 rounded-2xl border border-gray-200 dark:border-white/5 opacity-50 shadow-sm dark:shadow-none">
                  <p className="text-[10px] font-bold text-purple-600 dark:text-purple-400 uppercase tracking-widest mb-2">Treatment Guideline</p>
                  <p className="text-sm font-medium text-gray-900 dark:text-white mb-2">Select a patient</p>
                  <p className="text-xs text-gray-500 dark:text-gray-400">Analysis will appear here after running the system.</p>
                </div>
                <div className="bg-white dark:bg-black/20 p-6 rounded-2xl border border-gray-200 dark:border-white/5 opacity-50 shadow-sm dark:shadow-none">
                  <p className="text-[10px] font-bold text-emerald-600 dark:text-emerald-400 uppercase tracking-widest mb-2">Preventive Care</p>
                  <p className="text-sm font-medium text-gray-900 dark:text-white mb-2">Select a patient</p>
                  <p className="text-xs text-gray-500 dark:text-gray-400">Analysis will appear here after running the system.</p>
                </div>
              </>
        ...
        >
          <div className="flex items-center gap-6 relative z-10">
            ...
            <div>
              <h3 className="text-xl font-display font-bold text-gray-900 dark:text-white uppercase tracking-tighter">Critical Alerts</h3>
              <p className="text-[10px] text-red-600/60 dark:text-red-400/60 font-bold uppercase tracking-[0.3em]">Immediate Action Required • {dashboardData?.alerts?.length || 0} Pending</p>
            </div>
          </div>
          <div className="flex flex-wrap gap-4 relative z-10">
            ...
            {(!dashboardData?.alerts || dashboardData.alerts.length === 0) && (
              <span className="text-[10px] font-bold text-gray-500 uppercase tracking-widest">No active alerts</span>
            )}
          </div>
        ...
        >
          ...
          >
            ...
            {(!dashboardData?.appointments || dashboardData.appointments.length === 0) && (
              <div className="p-12 text-center text-gray-500 font-bold uppercase tracking-widest text-xs">No appointments scheduled</div>
            )}
          </motion.div>
        ...
        <div className="space-y-8">
          ...
          >
            <div className="relative z-10">
              ...
              <h3 className="text-xl lg:text-2xl font-display font-bold mb-4 leading-tight">Total <br />Patients</h3>
              ...
              <p className="text-blue-600/70 dark:text-blue-100/70 text-xs font-bold uppercase tracking-widest">Active Registrations</p>
            </div>
          ...
          >
            <div className="relative z-10">
              ...
              <h3 className="text-xl lg:text-2xl font-display font-bold mb-4 leading-tight">Medical <br />Records</h3>
              <p className="text-4xl lg:text-5xl font-display font-bold text-gray-900 dark:text-white mb-2">
                {dashboardData?.stats?.recordsCount || 0}
              </p>
              <p className="text-purple-600/70 dark:text-purple-100/70 text-xs font-bold uppercase tracking-widest">Total Consultations</p>
            </div>
          ...
          >
            ...
            >
              <div className="flex items-center justify-between mb-8">
                <h3 className="text-2xl font-display font-bold text-gray-900 dark:text-white">Edit Profile</h3>
                <button 
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  >
                    <option value="" className="bg-white dark:bg-gray-900">Select Department</option>
