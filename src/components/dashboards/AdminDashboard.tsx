...
export default function AdminDashboard({ 
  ...
  return (
    ...
    >
      ...
      {/* IoT & Predictive Summary - AI Powered */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
        ...
        >
          <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-8 lg:mb-12 relative z-10 gap-4">
            <div>
              <h3 className="text-2xl lg:text-3xl font-display font-bold text-gray-900 dark:text-white uppercase tracking-tighter">{t('resource_management')}</h3>
              <p className="text-[10px] text-gray-500 dark:text-gray-600 font-bold uppercase tracking-[0.3em]">{t('capacity_management_model')}</p>
            </div>
          ...
          <div className="h-[250px] lg:h-[300px] relative z-10">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={predictiveData}>
                ...
                />
                <Bar dataKey="predicted" name="Predicted Admissions" fill="#3b82f6" radius={[8, 8, 0, 0]} />
                <Bar dataKey="staffNeeded" name="Staff Required" fill="#8b5cf6" radius={[8, 8, 0, 0]} />
                <Bar dataKey="medicineStockNeeded" name="Medicine Demand" fill="#f59e0b" radius={[8, 8, 0, 0]} />
              </BarChart>
            </ResponsiveContainer>
          </div>
        ...
        <div className="space-y-8 lg:space-y-12">
          ...
          >
            <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-8 lg:mb-12 relative z-10 gap-4">
              <div>
                <h3 className="text-2xl lg:text-3xl font-display font-bold text-gray-900 dark:text-white uppercase tracking-tighter">{t('smart_assets')}</h3>
                <p className="text-[10px] text-gray-500 dark:text-gray-600 font-bold uppercase tracking-[0.3em]">{t('iot_device_network')}</p>
              </div>
            ...
            <div className="space-y-4 lg:space-y-6 relative z-10">
              <div className="flex items-center justify-between p-4 lg:p-6 bg-white dark:bg-white/5 rounded-2xl lg:rounded-3xl border border-gray-200 dark:border-white/5 group/item hover:bg-gray-100 dark:hover:bg-white/10 transition-all shadow-sm dark:shadow-none">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-sm font-bold text-gray-900 dark:text-white">{t('active_nodes')}</p>
                    <p className="text-[10px] text-gray-500 font-bold uppercase">{t('all_systems_operational')}</p>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between p-6 bg-white dark:bg-white/5 rounded-3xl border border-gray-200 dark:border-white/5 group/item hover:bg-gray-100 dark:hover:bg-white/10 transition-all shadow-sm dark:shadow-none">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-sm font-bold text-gray-900 dark:text-white">{t('warnings')}</p>
                    <p className="text-[10px] text-gray-500 font-bold uppercase">{t('attention_required')}</p>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between p-6 bg-white dark:bg-white/5 rounded-3xl border border-gray-200 dark:border-white/5 group/item hover:bg-gray-100 dark:hover:bg-white/10 transition-all shadow-sm dark:shadow-none">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-sm font-bold text-gray-900 dark:text-white">{t('critical_errors')}</p>
                    <p className="text-[10px] text-gray-500 font-bold uppercase">{t('immediate_action')}</p>
                  </div>
                </div>
          ...
          >
            <div>
              <h3 className="text-3xl font-display font-bold text-gray-900 dark:text-white uppercase tracking-tighter">{t('operational_insights')}</h3>
              <p className="text-[10px] text-gray-500 dark:text-gray-600 font-bold uppercase tracking-[0.3em]">{t('performance_analysis')}</p>
            </div>
      ...
      >
        ...
        <Link to="/iot" className="bg-emerald-600/10 dark:bg-emerald-600/20 border border-emerald-500/20 p-10 rounded-[3rem] flex items-center justify-between group hover:bg-emerald-600/20 dark:hover:bg-emerald-600/30 transition-all">
          <div className="flex items-center gap-6">
            ...
            <div>
              <h3 className="text-2xl font-display font-bold text-gray-900 dark:text-white">{t('iot_network')}</h3>
              <p className="text-emerald-600/70 dark:text-emerald-200/70 text-xs font-bold uppercase tracking-widest">{t('iot_network_desc')}</p>
            </div>
          </div>
        ...
        >
          ...
          <div className="p-12 border-b border-gray-200 dark:border-white/5 flex flex-col sm:flex-row sm:items-center justify-between gap-6 relative z-10">
            <div>
              ...
              <p className="text-xs text-gray-500 font-bold uppercase tracking-widest">{t('inventory_management_desc')}</p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 divide-y md:divide-y-0 md:divide-x divide-gray-200 dark:divide-white/5 relative z-10">
            <div className="p-8 bg-white dark:bg-white/2">
              <p className="text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-4">Critical Supplies</p>
              <div className="flex items-end justify-between">
                <div>
                  <p className="text-3xl font-display font-bold text-gray-900 dark:text-white">N95 Masks</p>
                  <p className="text-sm font-medium text-red-600 dark:text-red-400 mt-1">Low Stock (150 left)</p>
                </div>
            ...
            <div className="p-8 bg-white dark:bg-white/2">
              <p className="text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-4">Medications</p>
              <div className="flex items-end justify-between">
                <div>
                  <p className="text-3xl font-display font-bold text-gray-900 dark:text-white">Amoxicillin</p>
                  <p className="text-sm font-medium text-emerald-600 dark:text-emerald-400 mt-1">Optimal (5,000 units)</p>
                </div>
                <div className="w-12 h-12 rounded-2xl bg-emerald-500/10 flex items-center justify-center border border-emerald-500/20">
                  <CheckCircle2 className="w-5 h-5 text-emerald-600 dark:text-emerald-500" />
                </div>
              </div>
              <p className="mt-6 text-xs text-gray-500 font-medium">Next order predicted in 14 days</p>
            </div>
            <div className="p-8 bg-white dark:bg-white/2">
              <p className="text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-4">Surgical Equipment</p>
              <div className="flex items-end justify-between">
                <div>
                  <p className="text-3xl font-display font-bold text-gray-900 dark:text-white">Scalpels</p>
                  <p className="text-sm font-medium text-blue-600 dark:text-blue-400 mt-1">Sufficient (800 left)</p>
                </div>
                <div className="w-12 h-12 rounded-2xl bg-blue-500/10 flex items-center justify-center border border-blue-500/20">
                  <Activity className="w-5 h-5 text-blue-600 dark:text-blue-500" />
                </div>
              </div>
              <p className="mt-6 text-xs text-gray-500 font-medium">Usage rate: 50/day</p>
            </div>
            <div className="p-8 bg-white dark:bg-white/2 flex flex-col justify-center items-center text-center">
              ...
              <p className="text-sm font-bold text-gray-900 dark:text-white mb-1">System Insights</p>
              <p className="text-xs text-gray-500">Predicting 20% increase in flu medication demand next week.</p>
            </div>
          </div>
        </motion.div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
        ...
        >
          <div className="flex items-center justify-between mb-8 relative z-10">
            <h3 className="text-xl font-display font-bold text-gray-900 dark:text-white uppercase tracking-tighter">{t('system_monitor')}</h3>
            <div className="flex items-center gap-2">
              <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse" />
              <span className="text-[8px] font-bold text-green-500 uppercase tracking-widest">{t('live')}</span>
            </div>
          </div>
          
          <div className="space-y-6 relative z-10">
            <MonitorMetric label={t('cpu_load')} value={systemMonitor?.cpu || '0%'} icon={Cpu} color="blue" />
            <MonitorMetric label={t('memory')} value={systemMonitor?.memory || '0GB / 16GB'} icon={Database} color="purple" />
            <MonitorMetric label={t('network')} value={systemMonitor?.network || '0 MB/S'} icon={Wifi} color="green" />
            <MonitorMetric label={t('security')} value={systemMonitor?.security || 'ENCRYPTED'} icon={Lock} color="orange" />
          </div>
          ...
          <div className="mt-10 pt-8 border-t border-gray-200 dark:border-white/5 relative z-10">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-[10px] font-bold text-gray-500 uppercase tracking-widest">{t('kernel_logs')}</span>
            </div>
            <div className="font-mono text-[9px] text-gray-500 dark:text-gray-600 space-y-2">
              <p className="flex gap-2"><span className="text-blue-600/50 dark:text-blue-500/50">[05:59:49]</span> AUTH_SERVICE: User login verified</p>
              <p className="flex gap-2"><span className="text-blue-600/50 dark:text-blue-500/50">[05:59:42]</span> DB_SYNC: 12 records updated</p>
              <p className="flex gap-2"><span className="text-blue-600/50 dark:text-blue-500/50">[05:59:35]</span> ANALYTICS: Snapshot generated</p>
            </div>
          </div>
      ...
      >
        <div className="p-6 lg:p-12 border-b border-white/5 flex flex-col lg:flex-row lg:items-center justify-between gap-8 lg:gap-12 relative z-10">
          <div>
            <h3 className="text-2xl lg:text-3xl font-display font-bold text-white mb-2 uppercase tracking-tighter">{t('queue_management')}</h3>
            <p className="text-[10px] text-gray-600 font-bold uppercase tracking-[0.3em]">{t('awaiting_authorization')} • {t('high_priority')}</p>
          </div>
          ...
          <table className="w-full text-left min-w-[800px]">
            <thead>
              <tr className="bg-white/5">
                ...
                <th className="px-6 lg:px-12 py-6 lg:py-8 text-[10px] font-bold text-gray-600 uppercase tracking-[0.4em] text-right">{t('actions')}</th>
              </tr>
            </thead>
