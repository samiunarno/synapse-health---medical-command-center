          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                className="w-full bg-[#0033A0]/5 dark:bg-blue-600/10 text-[#0033A0] dark:text-blue-500 py-6 rounded-[2rem] font-bold text-sm uppercase tracking-widest hover:bg-[#0033A0] dark:hover:bg-blue-600 hover:text-white transition-all duration-500 border border-[#0033A0]/20 dark:border-blue-500/20 flex items-center justify-center gap-4 group interactive"
              >
