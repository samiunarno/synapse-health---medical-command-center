...
import { Pill, Plus, Minus, AlertTriangle, RefreshCw, ShoppingCart, Calendar, Trash2 } from 'lucide-react';

export default function MedicineInventory() {
  const [inventory, setInventory] = React.useState([
    { id: 1, name: "Paracetamol 500mg", stock: 12, minLevel: 5, dosage: "1 tablet", frequency: "As needed", expiry: "2026-12-01", autoRefill: true },
    { id: 2, name: "Amoxicillin 250mg", stock: 4, minLevel: 10, dosage: "1 capsule", frequency: "3 times daily", expiry: "2026-06-15", autoRefill: true },
    { id: 3, name: "Metformin 500mg", stock: 45, minLevel: 20, dosage: "1 tablet", frequency: "Twice daily", expiry: "2027-01-10", autoRefill: false },
  ]);
            ...
            >
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex flex-wrap gap-6">
                    ...
                    <div className="flex items-center gap-2 text-gray-500">
                      ...
                      <span className="text-[10px] font-bold uppercase tracking-widest">Expires: {item.expiry}</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-wrap items-center gap-8 lg:gap-12">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button className="p-4 bg-white/5 hover:bg-red-600 text-gray-400 hover:text-white rounded-2xl transition-all border border-white/5">
